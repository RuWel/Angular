...
export class RestService {
  ...
  createTutorial(tutorial: ITutorial, file: File): Observable<ITutorial> {
    ...
    return this.httpClient.post<ITutorial>(this.baseURL+"tutorials", restParams);
  }

  getAllTutorials(): Observable<ITutorial[]> {
    return this.httpClient.get<ITutorial[]>(this.baseURL + "tutorials");
  }

  updateTutorial(tutorial: ITutorial): Observable<ITutorial> {
    return this.httpClient.put<ITutorial>(this.baseURL+"tutorials/"+tutorial.id, tutorial);
  }

  updateTutorialWithFile(tutorial: ITutorial, file: File): Observable<ITutorial> {
    let restParams: FormData = new FormData();
    ...
    return this.httpClient.put<ITutorial>(this.baseURL+"tutorials/file/"+tutorial.id, restParams);
  }

  deleteTutorial(id: number) {
    return this.httpClient.delete(this.baseURL+"tutorials/delete/" + id);
  }
  ...
  findTutorialById(id: number) {
    return this.httpClient.get<ITutorial>(this.baseURL+"tutorials/find/" + id);
  }

  // REST API = findAllTutorials(boolean)
  findAllPublishedTutorials() {
    return this.httpClient.get<ITutorial[]>(this.baseURL+"tutorials/find?published="+true);
  }

  findAllUnpublishedTutorials() {
    return this.httpClient.get<ITutorial[]>(this.baseURL+"tutorials/find?published="+false);
  }

  findTutorialsByKeywords(keywords: string[]) {
    let args: string = this.buildArgs(keywords);

    return this.httpClient.get<ITutorial[]>(this.baseURL+"tutorials/find/keywords?"+args);
  }
  ...
  publishTutorial(id: number) {
    return this.httpClient.put(this.baseURL+"tutorials/publish/" + id, null);
  }
